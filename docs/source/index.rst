...
Class                   Description
======================= ======================================================================================
:ref:`GibbsChain`       A Gibbs-sampling class for performing Markov-chain Monte-Carlo sampling.
:ref:`HamiltonianChain` A class for performing Hamiltonian Markov-chain Monte-Carlo sampling.
:ref:`GaussianKDE`      Provides a function which approximates a PDF using Gaussian kernel-density estimation.
:ref:`UnimodalPdf`      Model-based estimation of PDFs for unimodal, univariate distributions.
:ref:`GpRegressor`      Gaussian-process regression for unstructured data in one or more dimensions.
:ref:`GpOptimiser`      Bounded global optimisation using Gaussian-processes.
======================= ======================================================================================
