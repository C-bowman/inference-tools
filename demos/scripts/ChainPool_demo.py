...
if __name__ == "__main__":
    ...
    chain = GibbsChain(posterior=rosenbrock, start=[0.0, 0.0])
    ...
    chain_1 = GibbsChain(posterior=rosenbrock, start=[0.5, 0.0])
    chain_2 = GibbsChain(posterior=rosenbrock, start=[0.0, 0.5])
